...
const theme = createTheme({
  ...
  typography: {
    ...
    fontSize: 16, // Default is 14, so this makes everything a bit bigger

    // Increase specific header sizes
    h4: {
      fontWeight: 700,
      fontSize: "2.2rem", // A bit larger than the default
    },
    h6: {
      fontWeight: 600,
      fontSize: "1.25rem", // Larger for card titles
    },
...
function App() {
  ...
  const drawer = (
    <div>
      ...
      >
        <i
          className="ph-fill ph-magic-wand text-4xl"
            ...
            <ListItem key={item.id} disablePadding>
              <ListItemButton
                selected={
                  ...
                  (activeSection.includes("report") && item.id === "history") ||
                  (activeSection.includes("peInsights") &&
                    item.id === "history")
                }
      ...
      <Box sx={{ display: "flex" }}>
        ...
        >
            ...
            <div id="message-area" style={{ marginBottom: "24px" }}>
              <div
                style={{
                  ...
                  borderRadius: "4px",
                  backgroundColor:
                    message.type === "error" ? "#ffebee" : "#e8f5e9",
          ...
          {activeSection === "upload" && (
            <UploadSection showAlert={showAlert} navigateTo={navigateTo} />
          )}
          {activeSection === "settings" && (
            <SettingsSection showAlert={showAlert} />
          )}
          {activeSection === "history" && (
            <HistorySection showAlert={showAlert} navigateTo={navigateTo} />
          )}
